...
// 按键引脚接口
#define BUTTON_PIN      (0)     // 按键引脚

// GNSS 引脚定义
#define GPS_RX_PIN      (18)    // 串口
#define GPS_TX_PIN      (17)    // 串口

// #define GPS_WAKEUP_PIN  (41) // 多余输出，GNSS模块唤醒主机,高电平有效
...
#define PIN_EINK_BUSY   (13)    // 忙状态输出引脚。当 BUSY 为高电平时，芯片的操作不应中断，且不应向模块发出任何命令
#define PIN_EINK_DC     (16)    // 高电平数据/低电平命令选择
#define PIN_EINK_RES    (12)    // 复位引脚
